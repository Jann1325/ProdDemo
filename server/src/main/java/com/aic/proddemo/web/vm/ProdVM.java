...
public class ProdVM {
    ...
    public ProdVM(Integer prodId, Integer restaurantId, String prodName, String prodText, String prodUserguide, Integer prodPrice, Integer prodQty, Integer prodState, byte[] prodPic, String prodPicBase64, Integer prodCommentNumber, Integer prodCommentScore, String resName, String resAdd, Integer resTypeId, String resType) {
        this.prodId = prodId;
        this.restaurantId = restaurantId;
        this.prodName = prodName;
        this.prodText = prodText;
