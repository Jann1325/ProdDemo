...
//    private List<ResTypeDetail> resTypeDetails;

    public Restaurant() {
    }


    public Restaurant(Integer restaurantId, String resAcc, String resPass, Integer resState, String resName,
    ...
    public String toString() {
        return "ProdRestaurantVO{" +
                ...
                ", resTexId='" + resTexId + '\'' +
                ", resOwnerName='" + resOwnerName + '\'' +
                ", resSeatNumber=" + resSeatNumber +
                ", resIntro='" + resIntro + '\'' +
                ", singleMeal=" + singleMeal +
                ", resTotalScore=" + resTotalScore +
                ", resTotalNumber=" + resTotalNumber +
                ", resMaxNum=" + resMaxNum +
                 '}';
    }
}
